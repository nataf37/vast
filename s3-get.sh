...
Example: $script your.s3.bucket us-east-1 /path/of/src/file.zip ./file.zip"
...
AWS_SERVICE='s3'
AWS_REGION="$2"
AWS_SERVICE_ENDPOINT_URL="172.21.38.1"
...
HTTP_REQUEST_PAYLOAD_HASH="UNSIGNED-PAYLOAD"
...
curl -k -v "http://${AWS_SERVICE_ENDPOINT_URL}${HTTP_CANONICAL_REQUEST_URI}" \
